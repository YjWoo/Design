...
import com.indigo.vincent.Activity.Activity_Capture;
...
public class GeneratePictureView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
                ...
                for (String path : webViewHelper.getAllListPath()) {
    ...
    public void changeDay(String strData, String userInfo, String userName, String other) {
        ...
        if (other == null)
            other = "";
        strData += "<br /><br />\n" +
                "<span style=\"font-size: small;line-height:150%;\">" + userInfo + "</span>\n" +
                "<br /><br />\n" +
                "<hr style=\"margin: auto;border:0;background-color:gray;height:1px;\"/>\n" +
                "<br />\n" +
                "<p style=\"color: orangered;font-size: x-small;text-align: center;letter-spacing: 0.5px;\">由<strong>" + userName + "</strong>发送<br />" + other + "</p>";

        webView.loadUrl("javascript:changeDayContent(\"" + strData.replace("\n", "\\n").replace("\"", "\\\"").replace("'", "\\'") + "\")");
    ...
    public void changeNight(String strData, String userInfo, String userName, String other) {
        ...
        if (other == null)
            other = "";
        strData = "<div style=\"color:black;display: inline;\">" + strData + "</div>";
        strData += "<br /><br />\n" +
                ...
                "\t\t<br />\n" +
                "\t\t<p style=\"color: purple;font-size: x-small;text-align: center;letter-spacing: 0.5px;\">由<strong>" + userName + "</strong>发送<br />" + other + "</p>";

        webView.loadUrl("javascript:changeNightContent(\"" + strData.replace("\n", "\\n").replace("\"", "\\\"").replace("'", "\\'") + "\")");
    }
